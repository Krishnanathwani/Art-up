...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-2 mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="posts/index.php"><i class="fas fa-palette"></i> Artworks</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"> </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"><i class="far fa-comment"></i> Chat</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"> </a>
        </li>
...
<br><br><br><br><br>
    ...
    <div class="container mt-5">
        ...
        <div class="text-center">
            <a href="create.php" class="btn btn-outline-light" style="border:3px solid; font-size:25px;">+ Create a new post</a>
        </div>
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card text-white bg-dark mt-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo substr($q['About'], 0, 50);?></p>
